(function() {
	...
	function ScheduleTemplate( element ) {
		...
		//thu
		this.modalEventNamename = this.modal.getElementsByClassName('cd-schedule-modal__namename')[0];
	...
	ScheduleTemplate.prototype.openModal = function(target) {
		...
		///thu
		this.modalEventNamename.textContent = target.getElementsByTagName('em')[0].textContent;
